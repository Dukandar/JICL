...
class PremiumCalculation {
  ...
  PremiumCalculation.formJson(
    ...
    objProductDetials = ObjProductDetials.formJson(
        sectionSubsectionDetails, benifitOverViewDetails);
    age = 31;
    ...
    objBusinessPartnerDetials =
        ObjBusinessPartnerDetials.formJson(sectionSubsectionDetails);
    objLoanBorrowerDetials =
        ObjLoanBorrowerDetials.formJson(sectionSubsectionDetails);
    objChildDetials = List<ObjChildDetials>.from(
        returnChildDetails(sectionSubsectionDetails)
            .map((e) => ObjChildDetials.formJson(e)));
    ...
    objQuoteMemberDetails = List<ObjQuoteMemberDetail>.from(
        returnObjMemberDetails(sectionSubsectionDetails, benifitOverViewDetails)
            .map((e) => ObjQuoteMemberDetail.formJson(e)));
    listPlan = null;
    lstPolicyTerm = null;
    lstPremiumTerm = null;
    lstLanguage = null;
    lstCountryCode = null;
    lstPrefMode = null;
    lstBenefitOverView = returnBenfitOverView(sectionSubsectionDetails,
        riderDetails, currentPage, benifitOverViewDetails);
    lstPremiumOverview = [];
  ...
  Map toJson() => {
        ...
        "objChildDetials":
            List<dynamic>.from(objChildDetials.map((e) => e.toJson())),
        ...
        "objQuoteMemberDetails":
            List<dynamic>.from(objQuoteMemberDetails.map((e) => e.toJson())),
        "ListPlan": listPlan,
        ...
        "LstBenefitOverView":
            List<dynamic>.from(lstBenefitOverView.map((e) => e.toJson())),
  ...
  List returnChildDetails(_subSectionDetails) {
    ...
    var dependentData =
        (_subSectionDetails[1010][dependentIndex] as SectionSubSection);
  ...
  String _returnMemberName(int _index, Map _sectionSubSectionDetails,
      bool _isSpouseCovered, List _childDetails) {
    switch (_index) {
      case 0:
        return (_sectionSubSectionDetails[1009][3] as SectionSubSection)
            .fieldValue;
      default:
        if (_isSpouseCovered && _index == 1) {
          return (_sectionSubSectionDetails[1010][10] as SectionSubSection)
              .fieldValue;
        } else {
          return _childDetails[((_isSpouseCovered) ? _index - 2 : _index - 1)]
              ["0"];
        }
    }
  }

  String _returnMemberDOB(int _index, Map _sectionSubSectionDetails,
      bool _isSpouseCovered, List _childDetails) {
    switch (_index) {
      case 0:
        return (_sectionSubSectionDetails[1009][7] as SectionSubSection)
            .fieldValue;
      default:
        if (_isSpouseCovered && _index == 1) {
          return (_sectionSubSectionDetails[1010][11] as SectionSubSection)
              .fieldValue;
        } else {
          return _childDetails[((_isSpouseCovered) ? _index - 2 : _index - 1)]
              ["2"];
  ...
  String _returnAge(int _index, Map _sectionSubSectionDetails,
      bool _isSpouseCovered, List _childDetails) {
    switch (_index) {
      case 0:
        return (_sectionSubSectionDetails[1009][8] as SectionSubSection)
            .fieldValue;
      default:
        if (_isSpouseCovered && _index == 1) {
          return (_sectionSubSectionDetails[1010][12] as SectionSubSection)
              .fieldValue;
        } else {
          return _childDetails[((_isSpouseCovered) ? _index - 2 : _index - 1)]
              ["3"];
  ...
  //MARK:- OBJ MemberDetails
  List returnObjMemberDetails(_subSectionDetails, Map benifitOverViewDetails) {
    List memberDetails = [];
    var _isSpouseCovered = false;
    List _membersDetailsList =
        _returnMembersDetailsWithDetails(_subSectionDetails);
    final selfToBeBeCoveredDetails =
        _subSectionDetails[1016][9] as SectionSubSection;
    final lifeToBeAssuredDetails =
        _subSectionDetails[1016][10] as SectionSubSection;
    ...
    final maritalStatusXndex =
        returnIndexWithField(1144, _subSectionDetails[1009]);
    var maritalStatusData =
        (_subSectionDetails[1009][maritalStatusXndex] as SectionSubSection);
    ...
    for (var i = 0; i < _membersDetailsList.length; i++) {
      ...
      if (benifitOverViewDetail != null) {
        final benifitCode = (benifitOverViewDetail.keys).elementAt(0);
        var premiumDetails =
            benifitOverViewDetail[benifitCode] as PremiumDetails;
        final Map<String, dynamic> details = {
          ...
          "MemberName": _returnMemberName(
              i, _subSectionDetails, _isSpouseCovered, tempArray),
          "MemberDOB": _returnMemberDOB(
              i, _subSectionDetails, _isSpouseCovered, tempArray),
          "TabIndex": null,
  ...
  List<LstBenefitOverView> returnBenfitOverView(_sectionDetails,
      Map riderDetails, int currentPage, Map benifitOverViewDetails) {
    ...
    for (var item in riderDetail) {
      LstBenefitOverView benefitDetails = LstBenefitOverView.formJson(
          _sectionDetails, item, currentPage, benifitOverViewDetails);
...
class ObjProductDetials {
  ...
  ObjProductDetials.formJson(
      Map sectionSubsectionDetails, Map benifitOverViewDetails) {
    ...
    planDescription =
        "A nontraditional life insurance policy, that combines the positives of a bank account and a life insurance policy giving the policyholder a higher return and a life protection.";
  ...
  retrunPlanNameWithPlanCode(String code) async {
    List<FieldData> fieldDataDetails =
        await DBHelper().getFieldDataWithFieldDataID(code, 1088);
...
class ObjSpouseDetails {
  ...
  ObjSpouseDetails.formJson(Map sectionSubsectionDetails) {
    ...
    age = ((spouseDetails[16] as SectionSubSection).fieldValue).length > 0
        ? int.parse((spouseDetails[16] as SectionSubSection).fieldValue)
        : 0;
    ...
    occupation =
        ((spouseDetails[17] as SectionSubSection).fieldValue.length <= 0)
            ? "2"
            : (spouseDetails[17] as SectionSubSection).fieldValue;
...
class ObjBusinessPartnerDetials {
  ...
  ObjBusinessPartnerDetials.formJson(Map sectionSubsectionDetails) {
    final spouseDetails = sectionSubsectionDetails[1016];
    age =
        0; //((spouseDetails[16] as SectionSubSection).fieldValue).length > 0 ? int.parse((spouseDetails[16] as SectionSubSection).fieldValue): 0;
...
class ObjChildDetials {
  ...
  ObjChildDetials.formJson(childDetials) {
    ...
    currentAge = (childDetials["Age"].length > 0)
        ? (int.parse(childDetials["Age"]) - 1)
        : 0;
    isDeleted = false;
    childCount = 0;
  }
...
class ObjQuoteMemberDetail {
  ...
  ObjQuoteMemberDetail.formJson(memberDetails) {
    ...
    age =
        (memberDetails["Age"].length > 0) ? int.parse(memberDetails["Age"]) : 0;
...
class LstBenefitOverView {
  ...
  LstBenefitOverView.formJson(Map sectionSubsectionDetails,
      RiderMaster riderDetails, int currentPage, Map benifitOverViewDetails) {
    final benifitOverViewDetail = benifitOverViewDetails[0];
    var premiumDetails =
        benifitOverViewDetail[riderDetails.benefitCode] as PremiumDetails;
    memberBenifitID = 0;
    benefitID = (riderDetails.benefitID.length > 0)
        ? int.parse(riderDetails.benefitID)
        : 0;
    ...
    isCashlessapplicable = null;
    objBenefitMemberRelationship = returnObjBenefitMemberRelationship(
        sectionSubsectionDetails,
        riderDetails,
        currentPage,
        benifitOverViewDetails,
        riderDetails.benefitCode);
    riderCode =
        (riderDetails.riderCode.length > 0) ? riderDetails.riderCode : null;
  ...
  Map toJson() => {
        ...
        "objBenefitMemberRelationship": List<dynamic>.from(
            objBenefitMemberRelationship.map((e) => e.toJson())),
        "RiderCode": riderCode,
  ...
  List<ObjBenefitMemberRelationship> returnObjBenefitMemberRelationship(
      _subSectionDetails,
      RiderMaster riderDetails,
      int currentPage,
      Map benifitOverViewDetails,
      String benefitCode) {
    ...
    List _membersDetailsList =
        _returnMembersDetailsWithDetails(_subSectionDetails);
    for (var i = 0; i < _membersDetailsList.length; i++) {
      ObjBenefitMemberRelationship objMemberDetails =
          ObjBenefitMemberRelationship.formJson(
              _subSectionDetails,
              i,
              riderDetails,
              currentPage,
...
class ObjBenefitMemberRelationship {
  ...
  ObjBenefitMemberRelationship.formJson(
      ...
      Map benifitOverViewDetails,
      String benefitCode,
      Map memberRelationshipMap) {
    final benifitOverViewDetail = benifitOverViewDetails[i];
    if(benifitOverViewDetail != null){
       var premiumDetails = benifitOverViewDetail[benefitCode] as PremiumDetails;
    policyMemberBenefitID = 0;
    riderSI = (benifitOverViewDetail[benefitCode] != null)
        ? ((premiumDetails.sumAssured.length > 0)
